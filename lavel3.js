...
background_image = "smart-city-trans-feature_1200x675_hero_012320-animated.gif";
...
hurdles_x_5 = 650;
hurdles_y_5 = -1100;
player_image = "road sweeper3.png";
...
function check() {
    ...
    function win() {
        ...
        startscreen.innerHTML = "Game win <br> Your final score is " + player.score+
        "<br> Press here to Next Lavel for the game";
        window.location="lavel3.html"
}
        
    if (player_x == canvas.width && player.score < 100) {
          window.location="lavel3.html"
          win()
    } 
